...
def createdomain(wlHome,domainHome,adminip,adminport,CURRENT_HOME):
    BOOT_HOME = CURRENT_HOME+"boot.properties"
    loadProperties(BOOT_HOME)
    print "wlHome="+wlHome
    print "adminPort="+adminport
    print "adminIP="+adminip
    print "domainHome="+domainHome
    print "password="+password 
    print "BOOT_HOME="+BOOT_HOME
...
createdomain(sys.argv[1],sys.argv[2],sys.argv[3],sys.argv[4],sys.argv[5])
